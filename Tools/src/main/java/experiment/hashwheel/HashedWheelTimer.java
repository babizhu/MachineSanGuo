...
/**
 * A {@link experiment.hashwheel.ITimer} optimized for approximated I/O timeout scheduling.
 * <p/>
 * <h3>Tick Duration</h3>
 * <p/>
 * As described with 'approximated', this timer does not execute the scheduled
 * {@link experiment.hashwheel.ITimerTask} on time.  {@link experiment.hashwheel.HashedWheelTimer}, on every tick, will
 * check if there are any {@link experiment.hashwheel.ITimerTask}s behind the schedule and execute
 * them.
 * <p/>
 ...
 * <p/>
 * {@link experiment.hashwheel.HashedWheelTimer} maintains a data structure called 'wheel'.
 * To put simply, a wheel is a hash table of {@link experiment.hashwheel.ITimerTask}s whose hash
 ...
 * <p/>
 * {@link experiment.hashwheel.HashedWheelTimer} creates a new thread whenever it is instantiated and
 ...
 * <p/>
 * {@link experiment.hashwheel.HashedWheelTimer} is based on
...
//                    HashedWheelTimer.class, 1, Runtime.getRuntime().availableProcessors() * 4);
    ...
    private final AtomicInteger workerState = new AtomicInteger(); // 0 - init, 1 - started, 2 - shut down
     ...
     *                      {@link experiment.hashwheel.ITimerTask} execution.
...
//        }
    ...
    @Override
    public ITimeout newTimeout(ITimerTask task, long delay, TimeUnit unit){
        start();
