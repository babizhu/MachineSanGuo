...
/**
 * user         LIUKUN
 * time         2014-5-12 16:31
 * 个人感觉这段代码错误多多，只能凑合看看意思
 */
        ...
        server.accept( null, new CompletionHandler<AsynchronousSocketChannel, Object>(){
            ...
            public void completed( AsynchronousSocketChannel result, Object attachment ){
                ...
                try {
                    ...
                    buffer.flip();
                    System.out.println( Thread.currentThread().getName() + ": Echo " + new String( buffer.array() ).trim() + " to " + result );
